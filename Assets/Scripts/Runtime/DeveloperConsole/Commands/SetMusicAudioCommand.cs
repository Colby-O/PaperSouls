...
{
    [CreateAssetMenu(fileName = "SetMusicAudioCommand", menuName = "Console Commands/Settings/SetMusicAudio")]
    internal sealed class SetMusicAudioCommand : ConsoleCommand
    {
        public override bool Process(string[] args, out ConsoleResponse msg)
        {
            ...
            GameManager.GetMonoSystem<IAudioMonoSystem>().SetMusicVolume(level);
