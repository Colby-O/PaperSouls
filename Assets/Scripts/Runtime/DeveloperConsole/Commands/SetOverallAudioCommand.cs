...
{
    [CreateAssetMenu(fileName = "SetOverallAudioCommand", menuName = "Console Commands/Settings/SetOverallAudio")]
    internal sealed class SetOverallAudioCommand : ConsoleCommand
    {
        public override bool Process(string[] args, out ConsoleResponse msg)
        {
            ...
            GameManager.GetMonoSystem<IAudioMonoSystem>().SetOverallVolume(level);
